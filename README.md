<div align="center">
  ...
  <h1>🛍️ MyEShop</h1>
  <h3 id="project-tagline-en">✨ Full-featured Online Store with ASP.NET Core 8 + Bootstrap 5 ✨</h3>
  <h3 id="project-tagline-fa" style="display:none;">✨ فروشگاه اینترنتی کامل با ASP.NET Core 8 + Bootstrap 5 ✨</h3>
  
  <!-- Language Switcher -->
  <p>
    <button onclick="switchLanguage('en')" id="btn-en" style="padding:8px 20px;margin:5px;cursor:pointer;background:#007bff;color:white;border:none;border-radius:5px;font-weight:bold;">🇬🇧 English</button>
    <button onclick="switchLanguage('fa')" id="btn-fa" style="padding:8px 20px;margin:5px;cursor:pointer;background:#6c757d;color:white;border:none;border-radius:5px;font-weight:bold;">🇮🇷 فارسی</button>
  </p>
  ...
  <p id="badges-fa" style="display:none;">
    <a href="https://rita00st.github.io/MyEShop/"><img src="https://img.shields.io/badge/🌐%20نسخه‌ی%20زنده-موفق-brightgreen?style=for-the-badge" alt="نسخه زنده"></a>
    <a href="https://github.com/rita00st/MyEShop"><img src="https://img.shields.io/github/stars/rita00st/MyEShop?style=for-the-badge&logo=github" alt="ستاره‌ها"></a>
    <a href="https://github.com/rita00st/MyEShop/issues"><img src="https://img.shields.io/github/issues/rita00st/MyEShop?style=for-the-badge&logo=github" alt="مشکلات"></a>
    <a href="https://github.com/rita00st/MyEShop/blob/main/LICENSE"><img src="https://img.shields.io/github/license/rita00st/MyEShop?style=for-the-badge" alt="لایسنس"></a>
  </p>
  ...
  <p id="tech-badges-fa" style="display:none;">
    <img src="https://img.shields.io/badge/.NET-8.0-512BD4?style=flat-square&logo=dotnet&logoColor=white" alt=".NET">
    <img src="https://img.shields.io/badge/C%23-8.0-239120?style=flat-square&logo=csharp&logoColor=white" alt="C#">
    <img src="https://img.shields.io/badge/EF%20Core-8.0-512BD4?style=flat-square&logo=entity-framework&logoColor=white" alt="EF Core">
    <img src="https://img.shields.io/badge/SQL%20Server-2019-CC2927?style=flat-square&logo=microsoftsqlserver&logoColor=white" alt="SQL Server">
...
<!-- Persian Content -->
<div id="content-fa" dir="rtl" align="right" style="display:none;">
  <h2>📖 درباره پروژه</h2>
...
cd MyEShop</code></pre>
    ...
    <li><strong>تنظیم اتصال به دیتابیس</strong> در فایل <code>appsettings.json</code>:
      <pre><code>"ConnectionStrings": {
  "MyConnection": "Server=YOUR_SERVER;Database=EshopCore_DB;Trusted_Connection=True;TrustServerCertificate=True;"
}</code></pre>
    </li>
    <li><strong>اعمال مایگریشن‌ها</strong> (ساخت جداول):
      <pre><code>dotnet ef database update</code></pre>
    </li>
    <li><strong>اجرای پروژه:</strong>
      <pre><code>dotnet run</code></pre>
...
function switchLanguage(lang) {
  ...
  document.getElementById('content-fa').style.display = 'none';
  
  // Show the selected language content
  if (lang === 'en') {
    document.getElementById('content-en').style.display = 'block';
    document.getElementById('badges-en').style.display = 'block';
    document.getElementById('badges-fa').style.display = 'none';
    document.getElementById('tech-badges-en').style.display = 'block';
    document.getElementById('tech-badges-fa').style.display = 'none';
    document.getElementById('project-tagline-en').style.display = 'block';
    document.getElementById('project-tagline-fa').style.display = 'none';
    document.getElementById('btn-en').style.background = '#007bff';
    document.getElementById('btn-fa').style.background = '#6c757d';
  } else {
    document.getElementById('content-fa').style.display = 'block';
    document.getElementById('badges-fa').style.display = 'block';
    document.getElementById('badges-en').style.display = 'none';
    document.getElementById('tech-badges-fa').style.display = 'block';
    document.getElementById('tech-badges-en').style.display = 'none';
    document.getElementById('project-tagline-fa').style.display = 'block';
    document.getElementById('project-tagline-en').style.display = 'none';
    document.getElementById('btn-fa').style.background = '#007bff';
